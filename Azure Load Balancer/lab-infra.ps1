...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/Esinrogunjo/Azure-kodekloud-az104-v1-/main/Azure%20Load%20Balancer/jumpbox.sh'); commandToExecute = './jumpbox.sh'}
}
